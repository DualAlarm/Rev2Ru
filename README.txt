...
Также дополнительно добавлен конфиг для включения возможности пропускать начальный экран.
Файл отправляется по пути steamapps\common\GUILTY GEAR Xrd -REVELATOR-\REDGame\Config
